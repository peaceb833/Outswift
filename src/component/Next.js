        ...
        <div className=' next-container   py-3' id='How'>
          ...
          <div className='text-center   mt-3'>
            <div className=''>
                ...
                <div className='col-md-4 '><FontAwesomeIcon icon={faCab} className="    bg-primary   font "/> <p className='h6 fw-bold text-secondary small mt-2' >Free collection and delivery</p>
                </div>
                <div className='col-md-4  '><FontAwesomeIcon icon={faPhone} className="   bg-primary font  "/> <p className='h6 fw-bold text-secondary mt-2 small ' >Dedicated 24/7 support</p>
                </div>
            </div>
          ...
          <div className='col-md-6 mx-auto  '>
           ...
           <div className=' container row'>
            <div  className='col-md-6  text-center' data-aos="fade-right">
              ...
              <div className='col-md-6 text-right mt-4 mt-md-0 p-2 mx-3 mx-md-0' >
