...
<div className=' footer bg-secondary   '>
   <div className='container row'>
        <div class="re text-white col-6 col-md-3 ">
          <p class="last-title text-white fw-bold mx-5 ">Quick Links</p>
          <ul class="remove mt-3 text-white liststyle-none ">
        ...
        <div class=" re col-6 col-md-3  ">
          <p class="last-title text-white fw-bold mx-4 ">Our Service</p>
          <ul class="remove text-left">
        <a href="#"  className="info  text-white"> <li>Laundry Service</li></a>
         ...
         <a href="#" className="info  text-white"> <li>Household Laundry</li></a> 
        ...
        <div class=" col-6 col-md-3  re"><p class="last-title text-white fw-bold mx-5"> Work with us</p>
        <ul class="remove mt-3 mx-3">
