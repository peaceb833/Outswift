...
<img class="card-img-top" src={item.img} alt=" product"/>

<div class="card-body">

<h5 class="card-title h6 text-primary">{item.Title}</h5>

<p class="card-text small fw-bold text-secondary"><FontAwesomeIcon icon={faNairaSign} className='small'/>{item.price}</p>

<button class="btn btn-primary" onClick={()=>addItem(item)}>Add to cart</button>
